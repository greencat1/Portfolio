...
The **Courses** folder contains coursework, assignments, and capstone projects completed as part of structured learning programs, primarily from the **University of Michigan (Coursera)**.
...
Pet projects highlight initiative, curiosity, and applied machine learning skills.
...
- Serve as a professional portfolio for data-related roles and collaborations  
